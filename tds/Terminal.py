...
⣿⣿⣿⣿⣿⣿⣿⡇⣿⡇⣿⣿⣿⣿⣿⡈⡇⠀⢸⣀⡏⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⠻⣦⣙⠳⣦⣀⠀⠈⠳⣿⢷⡄⠈⢿⣎⢧⠀⠀⠀⠀⠀⠀⠀⠀⠀
⣿⣿⣿⣿⣿⣿⣿⡇⣿⡇⣿⣿⢿⢹⡏⢷⡇⠀⠈⣿⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣙⠷⣦⣝⣳⣦⣄⢙⣧⣿⠀⢸⣿⡜⣦⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
 \033[1;33m   + Help : Để coi các lệnh có thể sử dụng.
    + Terminal by Citynight x KhanhNguyen9872.\033[0m""")
        while 1:
            try:
                bin.shell()
    ...
    def shell():
        ...
        print("\n{1}┌──({3}{2}@localhost{1})-[{0}{4}{1}]".format(Color.reset(),Color.green(),Color.blue(),user,"~" if os.getcwd()==os.path.expanduser('~') else os.getcwd()))
...
def _help(arg=[]):
    print("""Shell by Citynight X KhanhNguyen9872
